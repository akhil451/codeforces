...
# In one move you can increase a by 1 (replace a with a+1). Your task is to 
...
# integer t (1≤t≤104) — the number of test cases. Then t test cases follow.
...
# the minimum number of moves you need to do in order to make a divisible by b.
